...
WebUI.setText(findTestObject('Object Repository/Page_ng k/input_H v tn m ()_lastname'), last_name)

WebUI.setText(findTestObject('Object Repository/Page_ng k/input_Tn ()_firstname'), first_name)

WebUI.setText(findTestObject('Object Repository/Page_ng k/input_a ch_address'), address)

WebUI.setText(findTestObject('Object Repository/Page_ng k/input_TrngNi cng tc_school'), company)

WebUI.setText(findTestObject('Object Repository/Page_ng k/input_S in thoi_phone'), phone)
