...
WebUI.setText(findTestObject('Object Repository/Page_To cng vic/input_Tn cng vic_name'), 'Job Invalid Salary')

WebUI.setText(findTestObject('Object Repository/Page_To cng vic/textarea_M t_description'), 'mô tả')

WebUI.setText(findTestObject('Object Repository/Page_To cng vic/input_VN_salary'), '-12351')

WebUI.setText(findTestObject('Object Repository/Page_To cng vic/textarea_a ch_address'), '321')
