...
WebUI.setText(findTestObject('Object Repository/Page_To cng vic/input_Tn cng vic_name'), 'Test')

WebUI.setText(findTestObject('Object Repository/Page_To cng vic/textarea_M t_description'), 'Test')

WebUI.setText(findTestObject('Object Repository/Page_To cng vic/input_VN_salary'), '123456')

WebUI.setText(findTestObject('Object Repository/Page_To cng vic/textarea_a ch_address'), 'Test')
